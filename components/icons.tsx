...
export const WandIcon: React.FC<{ className?: string }> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.5 3.5l-1.5 1.5M12 6l-1.5-1.5M12 6l1.5 1.5M12 6v2m-2.5-1.5l-1.5-1.5M9.5 3.5l1.5 1.5M3 14l6-6m0 0l6 6m-6-6v14" />
    </svg>
);
...
export const MicrophoneIcon: React.FC<{ className?: string; isListening?: boolean }> = ({ className = 'w-6 h-6', isListening = false }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`${className} ${isListening ? 'text-red-500 animate-pulse' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M19 11a7 7 0 01-14 0m7 6v4m0 0H9m4 0h2m-4-8a4 4 0 014-4h0a4 4 0 014 4v3a4 4 0 01-4 4h0a4 4 0 01-4-4v-3z" />
    </svg>
);
